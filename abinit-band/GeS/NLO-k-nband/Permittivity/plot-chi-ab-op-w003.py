...
for i in [0.001, 0.005, 0.01, 0.05, 0.1]:
    ...
    for j in [0.02, 0.05, 0.1]:
        ...
        ax1.plot(abinit[:599,0], abinit[:599,1], linewidth=0.5, linestyle='--', label='abinit' + str(i) + '_' + str(j))
        ax2.plot(abinit[599:1197,0], abinit[599:1197,1], linewidth=0.5, linestyle='--', label='abinit' + str(i) + '_' + str(j))
