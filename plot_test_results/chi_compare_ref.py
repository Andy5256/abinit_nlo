...
chi_fl = abs(chi[:,2])
chi_ref = abs(chi[:,3])
ax1.scatter(chi_ref, chi_fl, color='b', marker='o',s=10, label='fl')
ax1.scatter(chi_ref, chi_ab, color='r', marker='o',s=10, label='ab')
ax1.scatter(chi_ref, chi_gxm, color='g', marker='o',s=10, label='gxm')
...
plt.yscale('log')
# plt.xlim(0,20)
plt.savefig('chi_compare_ref_log.png',dpi=300)
# %%
